...
class TitleState extends MusicBeatState
{
	...
	var alreadySetDaPrefs:Bool = false;
	var fpsCounterDidNotDisappear:Bool = true;
	...
	override public function create():Void
	{
		...
		optionsSave.bind('options', 'ninjamuffin99');

		// optionsSave.data.defaultSettingsNotSetYet;
