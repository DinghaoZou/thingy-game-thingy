...
class PlayerSettings
{
	...
	/*static public function savePreferences()
	{
		TitleState.optionsSave.data.censor_naughty = PreferencesMenu.getPref('censor-naughty');
		TitleState.optionsSave.data.downscroll = PreferencesMenu.getPref('downscroll');
		TitleState.optionsSave.data.ghost_tapping = PreferencesMenu.getPref('ghost-tapping');
		TitleState.optionsSave.data.flashing_menu = PreferencesMenu.getPref('flashing-menu');
		TitleState.optionsSave.data.camera_zoom = PreferencesMenu.getPref('camera-zoom');
		TitleState.optionsSave.data.timer = PreferencesMenu.getPref('timer');
		TitleState.optionsSave.data.fps_counter = PreferencesMenu.getPref('fps-counter');
		TitleState.optionsSave.data.auto_pause = PreferencesMenu.getPref('auto-pause');
		TitleState.optionsSave.data.testData;

		trace(TitleState.optionsSave.data.testData);
